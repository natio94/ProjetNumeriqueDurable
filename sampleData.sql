use marketplace;
INSERT INTO utilisateurs (nom, prenom, email, password, postal_code) VALUES
('Doe', 'John', 'john.doe@gmail.com', 'password123', '75001'),
('Smith', 'Jane', 'jane.smith@yahoo.com', 'pass456', '75002'),
('Dupont', 'Pierre', 'pierre.dupont@outlook.com', 'secure789', '75003'),
('Martin', 'Marie', 'marie.martin@gmail.com', 'motdepasse101', '75004'),
('Dubois', 'Luc', 'luc.dubois@free.fr', 'secret202', '75005');
...
(2, 'Robe d\'été', 'Robe légère en coton pour l\'été, taille M', 45.00, 2),
(2, 'Jean', 'Jean en denim bleu, taille 32', 60.00, 2),
(2, 'T-shirt', 'T-shirt en coton bio, taille L', 25.00, 2),
...
(4, 'Ballon de football', 'Ballon de football professionnel en cuir', 30.00, 5),
(4, 'Raquette de tennis', 'Raquette de tennis légère pour amateurs', 100.00, 5),
